...
· you do that by placing your personal data on secure repositories that make it easy for businesses to behave responsibly, honestly, and lawfully with your data
...
the **Human Internet Principles** guide the development of human·centric technologies, policies, and rules used in the ecosystem:
  ...
  * [entity_data][entity_data] belongs to the owner, who maintains total control over it  
...
before new [data_models][data_model] and [interaction_models][interaction_model] for them are introduced to the human internet, they are tested for a number of *years*  
...
[interaction_model]: #interaction_model "the set of operations that specify how data specialists perform a task or service with data or content"
...
[life_context]: #life_context "the state of an entity in real life at a particular time"


## market_agent
[data_specialist][data_specialist] who facilitates interactions between [market_sources][market_source] and consumers on a marketplace  

[market_agent]: #market_agent "data specialist who facilitates interactions between market sources and consumers on a marketplaces"


## market_source
entity that offers products or services for sale on a marketplace  

[market_source]: #market_source "entity that offers products or services for sale on marketplaces"
...
[marketplace_specification]: #marketplace_specification "describes how a marketplace operates, detailing its data and interaction models"


## network_effect
the [increased value](https://en.wikipedia.org/wiki/Network_effect "Wikipedia: network effect") of a service to its users by the addition of other users to the service  
...
## operating_system
the [main software](https://www.howtogeek.com/361572/what-is-an-operating-system "How-To Geek: What is an Operating System?") that manages the operations of hardware and firmware in a device to provide services to high·level software, such as apps   
...
[owned_data]: #owned_data "personal data that a person or entity stores in a datapod"


## personal_assistant
a [person](https://en.wikipedia.org/wiki/personal_assistant "Wikipedia: personal assistant") who assists a specific person in eir personal and business affairs  

[personal_assistant]: #personal_assistant "person that assists another person in eir personal and business affairs"


## personal_data
[entity_data][entity_data] that refers to a person (a human being or a legal person) 

[personal_data]: #personal_data "data about a person or that identifies that person"
...
[personal_identification_device]: #personal_identification_device "device equipped with a secure element, which a person uses to manage identity and data, and perform authentication and authorization operations"
...
a special, [secure chip](https://www.rambus.com/blogs/what-is-a-secure-element "Rambus: What is a Secure Element?") in a device, whose contents and operations are inaccessible by other hardware and software components  
...
[unit_testing]: https://searchsoftwarequality.techtarget.com/definition/unit-testing "SearchSoftwareQuality: unit testing"
[automated_learning]: https://en.wikipedia.org/wiki/Automated_machine_learning "Wikipedia: automated machine learning"
[cloud_computing]: https://en.wikipedia.org/wiki/Cloud_computing "Wikipedia: cloud computing"
